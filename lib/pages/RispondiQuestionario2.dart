...
import '../model/objects/Risposta2.dart';
import '../widgets/MessaggioDialogo.dart';
import 'PaginaAccesso.dart';

class RispondiQuestionario2 extends StatefulWidget {

  RispondiQuestionario2({required Key key}) : super(key: key);

  @override
  _SearchState createState() => _SearchState();
}
class _SearchState extends State<RispondiQuestionario2> {
    ...
    Map<String, dynamic> compilazione = {
      ...
      "risposte": widget.questionario
        ...
        return Risposta2(
          ...
          scelte: selezioniRisposte[index] != null
              ? domanda.risposte[selezioniRisposte[index]!]
              : "",
        );
      }).toList(),
    };
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      ElevatedButton(
                        onPressed: _eScaricata[indice]! || compilazioneSalvata
                            ? null
                            : () {
                      ...
                      Column(
                        children: domanda.risposte.asMap().entries.map((entry) {
                          ...
                          return RadioListTile<int>(
                            title: Text(risposta),
                            value: rispostaIndex,
                            groupValue: selezioniRisposte[indice],
                            onChanged: compilazioneSalvata
                                ? null
                                : (int? value) {
                              setState(() {
                                selezioniRisposte[indice] = value;
                              });
                            },
                          );
                        }).toList(),
